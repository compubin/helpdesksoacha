	...
	<div class="box-header with-border">
		...
		<div class="box-header-tools " >
			@if(Session::get('gid') ==1)
				<a href="{{ URL::to('tecno/module/config/'.$pageModule) }}" class="tips btn btn-xs btn-default" title=" {{ Lang::get('core.btn_config') }}" ><i class="fa  fa-ellipsis-v"></i></a>
			@endif 			
		</div> 
...
<div class="col-md-12">
					...
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-7">
										  <input  type='text' name='is_read' id='is_read' value='{{ $row['is_read'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('notification?return='.$return) }}' " class="btn btn-warning btn-sm "><i class="icon-cancel-circle2 "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
