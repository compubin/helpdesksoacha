...
{{--*/ usort($tableGrid, "SiteHelpers::_sort") /*--}}
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('notification') }}"> Home</a></li>
...
<div class="box box-primary">
	<div class="box-header with-border">
		<div class="box-header-tools pull-left" >
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('notification/update?return='.$return) }}" class="tips btn btn-sm btn-success btn-circle"  title="{{ Lang::get('core.btn_create') }}">
	...
	<div class="box-body no-padding"> 	
	 ...
	 {!! Form::open(array('url'=>'notification/delete/0?return='.$return, 'class'=>'form-horizontal' ,'id' =>'TecnoTable' )) !!}
        ...
        <tbody>        						
            @foreach ($rowData as $row)
                <tr>
					...
					<td>
					 	<div class="dropdown">
						  <button class="btn btn-success btn-outline btn-sm btn-circle dropdown-toggle" type="button" data-toggle="dropdown"> <i class="fa  fa-arrow-down"></i>
