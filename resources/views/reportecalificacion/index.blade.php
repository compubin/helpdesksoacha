...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<div class="box-header-tools pull-left" >
			@if($access['is_add'] ==1)
	   		<a href="{{ url('reportecalificacion/update?return='.$return) }}" class="tips btn btn-success btn-circle btn-sm"  title="{{ Lang::get('core.btn_create') }}">
			...
			@endif 
			<a href="{{ url( 'reportecalificacion/search?return='.$return) }}" class="btn btn-warning btn-sm btn-circle" onclick="TecnoModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}"><i class="fa  fa-search"></i> </a>				
	...
	<div class="box-body "> 	
	 ...
	 {!! Form::open(array('url'=>'reportecalificacion/delete/', 'class'=>'form-horizontal' ,'id' =>'TecnoTable' )) !!}
					...
					<td>
					 	<div class="dropdown">
						  ...
						  <ul class="dropdown-menu">
							...
							{{--<li><a href="{{ url('reportecalificacion/show/'.$row->id.'?return='.$return)}}" class="tips" title="{{ Lang::get('core.btn_view') }}"><i class="fa  fa-search "></i> {{ Lang::get('core.btn_view') }} </a></li>--}}
							@endif
							@if($access['is_edit'] ==1)
							{{--<li><a  href="{{ url('reportecalificacion/update/'.$row->id.'?return='.$return) }}" class="tips" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit "></i> {{ Lang::get('core.btn_edit') }} </a></li>--}}
							@endif
						  </ul>
						</div>
...
$(document).ready(function(){
	...
	$('.copy').click(function() {
		...
		{
				$('#TecnoTable').attr('action','{{ url("reportecalificacion/copy")}}');
