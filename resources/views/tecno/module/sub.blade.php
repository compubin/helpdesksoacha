...
<div class="box box-primary">
 <div class="box-header with-border"><h4> {{ $row->module_title }} <small> Master Detail :  Manage View Lookup </small></h4></div>
  <div class="box-body">  
    ...
    @include('tecno.module.tab',array('active'=>'sub','type'=> $type))
  
    {!! Form::open(array('url'=>'tecno/module/savesub/'.$module_name, 'class'=>'form-horizontal  ' ,'id'=>'fSub')) !!}
    ...
    <tbody class="no-border-x no-border-y"> 
      ...
      <tr>
        ...
        onclick="TecnoConfirmDelete('{{ URL::to('tecno/module/removesub?id='.$row->module_id.'&mod='.$rows['module']) }}');" 
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo TecnoHelpers::sjForm('fSub'); ?>
