...
@endif
 ...
 {!! Form::open(array('url'=>'tecno/module/savepermission/'.$module_name, 'class'=>'form-horizontal' ,'id'=>'fPermission')) !!}

<div class="box box-primary">
 <div class="box-header with-border"> <h4> {{ $row->module_title }} <small> : Permission  ( Set Access to Groups ) </small></h4></div>
	<div class="box-body ">	

	@include('tecno.module.tab',array('active'=>'permission','type'=>$type))
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo TecnoHelpers::sjForm('fPermission'); ?>
