...
@include('tecno.module.tab',array('active'=>'config','type'=> $type))



	<div class="col-md-6">
	{!! Form::open(array('url'=>'tecno/module/saveconfig/'.$module_name, 'class'=>'form-horizontal ','id'=>'configA' , 'parsley-validate'=>'','novalidate'=>' ')) !!}
	<input  type='hidden' name='module_id' id='module_id'  value='{{ $row->module_id }}'   />
	  ...
	  <div class="form-group" style="display:none;" >
		...
		<div class="form-group">
			...
			<div class="col-md-8 " >
						<b>Form Shortcode : </b><code><br /><?php echo "!!TecnoHelpers|showForm|".$row->module_name."!!"; ?></code><br />
 ...
 @if($type !='report' && $type !='generic')
  {!! Form::open(array('url'=>'tecno/module/savesetting/'.$module_name, 'class'=>'form-horizontal ' ,'id'=>'configB')) !!}
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		<?php echo TecnoHelpers::sjForm('configA'); ?>
		<?php echo TecnoHelpers::sjForm('configB'); ?>
