...
<div class="box box-primary">
 ...
 <div class="box-body ">
  ...
  @include('tecno.module.tab',array('active'=>'sql','type'=>  $type ))
  
 {!! Form::open(array('url'=>'tecno/module/savesql/'.$module_name, 'class'=>'form-vertical ' ,'id'=>'SQL' , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo TecnoHelpers::sjForm('SQL'); ?>
