...
<div class="box box-primary">
 <div class="box-header with-border"><h4> {{ $row->module_title }}  <small> :  Extend form ( Setting Child Form ) </small> </h4></div>
  <div class="box-body">  
    ...
    @include('tecno.module.tab',array('active'=>'subform'))

<ul class="nav nav-tabs" style="margin-bottom:10px;">
    <li  ><a href="{{ URL::to('tecno/module/form/'.$module_name)}}">Form Configuration </a></li>
    <li class="active" ><a href="{{ URL::to('tecno/module/subform/'.$module_name)}}">Sub Form </a></li> 
  <li ><a href="{{ URL::to('tecno/module/formdesign/'.$module_name)}}">Form Layout</a></li> 
</ul>    
  
    {!! Form::open(array('url'=>'tecno/module/savesubform/'.$module_name, 'class'=>'form-horizontal  ','id'=>'fSubf')) !!}
        ...
        <div class="col-md-8">
          ...
          <a href="{{ url('tecno/module/subformremove/'.$module_name) }}" class="btn btn-danger"><i class="icon-cancel-circle2 "></i> Remove </a>
          @endif
         </div> 
        </div> 
...
$(document).ready(function(){   
    $("#table").jCombo("{{ url('tecno/module/combotable') }}",
    {selected_value : "{{ (isset($subform['table']) ? $subform['table']: null ) }}" }); 
    $("#key").jCombo("{{ url('tecno/module/combotablefield') }}?table=",
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo TecnoHelpers::sjForm('fSubf'); ?>
