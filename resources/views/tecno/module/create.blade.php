...
@section('content')
 ...
 {!! Form::open(array('url'=>'tecno/module/create/', 'class'=>'form-horizontal', 'parsley-validate'=>'','novalidate'=>'')) !!}
	...
	<div class="form-group manualsql">
      ...
      <div class="form-group">
		...
		<div class="col-sm-9">	
	  	...
	  	<a href="{{ url('tecno/module')}}" class="btn btn-warning"> <i class="icon-backward"></i> Cancel </a>
		</div>	  
