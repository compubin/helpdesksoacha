...
<div class="box box-primary">
 <div class="box-header with-border"><h4> {{ $row->module_title }} <small> : Form Design Editor </small></h4></div>
	<div class="box-body ">	

	@include('tecno.module.tab',array('active'=>'form','type'=> 'addon'))
	...
	<ul class="nav nav-tabs" style="margin-bottom:10px;">
		...
		<li class="active" ><a href="{{ URL::to('tecno/module/formdesign/'.$module_name)}}">Form Layout</a></li> 
	</ul>
	
	<p class="alert alert-success"> <strong>Tips !</strong> Drag and drop rows to re ordering lists </p>	
 {!! Form::open(array('url'=>'tecno/module/formdesign/'.$module_name,'id'=>'doReorder', 'class'=>'form-vertical','parsley-validate'=>'','novalidate'=>' ')) !!}
