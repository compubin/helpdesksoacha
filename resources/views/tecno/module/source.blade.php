...
<div class="box box-primary">
 <div class="box-header with-border"> <h4> {{ $row->module_title }} <small> : Code Editor </small></h4></div>
	<div class="box-body ">	
 	...
 	@include('tecno.module.tab',array('active'=>'source'))
 		<div class="box">
 		...
 		<div class="box-body">
				...
				<div id="container_id"></div>
	 			...
	 			<div class="col-md-9" style="height: 600px;">
	 				...
	 				{!! Form::open(array('url'=>'tecno/module/code/'.$module_name, 'class'=>'form-horizontal','id'=>'FormCode' )) !!}
...
<script type="text/javascript">
    $(document).ready( function() {
        $('#container_id').fileTree({
            root: '/{{ $module_name}}/',
            script: '{{ url("tecno/module/source/folder")}}',
            expandSpeed: 1000,
            collapseSpeed: 1000,
            multiFolder: false
        }, function(file) {
        	$('.ajaxLoading').show();	
        	$.get( "{{ url('tecno/module/code/'.$module_name)}}",{ path:file}, function( data ) {
