			...
			<p class="text-center text-danger"></i>Becarefful !! Do with your own Risk  </p>		  
	 		...
	 		<div class="row">
	 			...
	 			<div class="col-md-8">
	 				...
	 				{!! Form::open(array('url'=>'tecno/code/save', 'class'=>'form-horizontal','id'=>'FormCode' )) !!}
...
<script type="text/javascript">
    $(document).ready( function() {
        $('#container_id').fileTree({
            root: '/',
            script: '{{ url("tecno/code/source/folder")}}',
            expandSpeed: 1000,
            collapseSpeed: 1000,
            multiFolder: false
        }, function(file) {
        	$('.ajaxLoading').show();	
        	$.get( "{{ url('tecno/code/edit/')}}",{ path:file}, function( data ) {
