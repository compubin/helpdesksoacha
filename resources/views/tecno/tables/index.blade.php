...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="ajaxLoading"></div>
			...
			<a href="{{ url('tecno/tables/tableconfig/')}}" class="btn btn-sm btn-success linkConfig tips" title="New Table "><i class="fa fa-plus"></i> </a>
			<a href="{{ url('tecno/tables/mysqleditor/')}}" class="btn btn-sm btn-info linkConfig tips" title="MySQL Editor"><i class="fa fa-pencil"></i>  </a>

		<div class="row">
			<div class="col-md-3">
				{!! Form::open(array('url'=>'tecno/tables/tableremove/', 'class'=>'form-horizontal','id'=>'removeTable' )) !!}
					...
					<table class="table">
						...
						@foreach($tables as $table)
							<tr>
								...
								<td><a href="{{ URL::TO('tecno/tables/tableconfig/'.$table)}}" class="linkConfig" > {{ $table }}</a></td>
								<td>
