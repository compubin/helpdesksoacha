...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="{{ url('dashboard') }}"> Home</a></li>
     <li><a href="{{ url('core/logs') }}">  Logs </a></li>
...
<div class="box box-success ">
	...
	<div class="box-body "> 	
	 ...
	 {!! Form::open(array('url'=>'core/logs/delete/', 'class'=>'form-horizontal' ,'id' =>'TecnoTable' )) !!}
            ...
            @foreach ($rowData as $row)
                <tr>
				 ...
				 <td>
						...
						<a href="{{ URL::to('core/logs/show/'.$row->auditID.'?return='.$return)}}" class="tips btn btn-xs btn-success" title="{{ Lang::get('core.btn_view') }}"><i class="fa  fa-search "></i></a>
						@endif
						@if($access['is_edit'] ==1)
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#TecnoTable').attr('action','{{ URL::to("logs/multisearch")}}');
		$('#TecnoTable').submit();
	});
