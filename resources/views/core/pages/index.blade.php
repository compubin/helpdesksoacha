...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="{{ url('dashboard') }}"> Home</a></li>
     <li><a href="{{ url('core/posts') }}">  PageCMS </a></li>
...
<div class="box box-success ">
	<div class="box-header with-border"> 
	    <div class="box-header-tools pull-left ">
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('core/pages/update') }}" class="tips btn btn-sm btn-success btn-circle"  title="{{ Lang::get('core.btn_create') }}">
			...
			<a href="{{ URL::to('core/pages/download') }}" class="tips btn btn-sm btn-info btn-circle" title="{{ Lang::get('core.btn_download') }}">
	...
	<div class="box-body "> 	
	 ...
	 {!! Form::open(array('url'=>'core/pages/delete/', 'class'=>'form-horizontal' ,'id' =>'TecnoTable' )) !!}
        ...
        <tbody>
            ...
            @foreach ($rowData as $row)
                <tr>
					...
					<td>
						<div class="dropdown">
						  <button class="btn btn-success btn-xs btn-outline btn-circle dropdown-toggle" type="button" data-toggle="dropdown"> <i class="fa fa-arrow-down"></i>
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#TecnoTable').attr('action','{{ URL::to("core/pages/multisearch")}}');
		$('#TecnoTable').submit();
	});
