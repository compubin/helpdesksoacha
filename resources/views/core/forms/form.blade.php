...
<div class="box box-primary">
	<div class="box-header with-border">
		<div class="box-header-tools pull-left" >
			...
			<a class="btn btn-xs btn-warning tips btn-circle" title="Documentation" href="{{ url('core/forms/docs') }}" onclick="TecnoModal(this.href,'Documentation'); return false;"><i class="fa fa-book"></i></a>
		</div>
