    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{ url('dashboard') }}"> Home</a></li>
         <li><a href="{{ url('core/pages') }}">  Post Article </a></li>
			...
			<div class="box box-info ">
				<div class="box-header with-border"> 
					<div class="box-header-tools pull-left" >
						@if($access['is_add'] ==1)
				   		<a href="{{ URL::to('core/posts/update?return='.$return) }}" class="tips btn btn-sm btn-success btn-circle"  title="{{ Lang::get('core.btn_create') }}">
						...
						@endif 
						<a href="{{ URL::to( 'core/posts/search') }}" class="btn btn-sm btn-primary btn-circle" onclick="TecnoModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}"><i class="fa  fa-search"></i> </a>	
					...
					<div class="box-header-tools pull-right" >
						...
						<a href="{{ URL::to('core/posts/download?return='.$return) }}" class="tips btn btn-sm btn-info btn-circle" title="{{ Lang::get('core.btn_download') }}">
				...
				<div class="box-body "> 	
				 ...
				 {!! Form::open(array('url'=>'core/posts/delete?return='.$return, 'class'=>'form-horizontal' ,'id' =>'TecnoTable' )) !!}
