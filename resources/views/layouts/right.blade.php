      ...
      <!-- Changelog tab content -->
       <div class="tab-pane " id="control-sidebar-info-tab">
          <div class="text-center">
              <h3 class="control-sidebar-heading">ABOUT TECNO 5 </h3>
              Version : 5.1.7 <br />
              ...
              <hr/>
              <div class="text-center">
                <a href="javascript:void(0)" onclick="TecnoModal('{{ url('core/template/changelog') }}','Tecno5 Changelog')"> All Changelogs </a> 
              </div>
      </div>   
      <!-- Home tab content -->
      ...
      <div class="tab-pane active" id="control-sidebar-settings-tab">
        <form method="post">
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ url('tecno/module')}}"> {{ Lang::get('core.dash_module') }} </a>
            </p>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ url('tecno/config')}}"> {{ Lang::get('core.dash_setting') }} </a>
            </p>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ url('tecno/menu')}}">  {{ Lang::get('core.dash_sitemenu') }} </a>
            </p>
          </div>
          <!-- /.form-group -->       
          ...
          <div class="form-group">
            ...
            <p>
               <a href="{{ url('tecno/code')}}"> {{ Lang::get('core.dash_sourceeditor') }} </a> 
            </p>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ url('tecno/tables')}}"> {{ Lang::get('core.dash_database') }} </a>
            </p>
          </div>
          <!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <p>
             <a href="{{ url('tecno/rac')}}"> Manage Access to modules </a>
            </p>
          </div>
          <!-- /.form-group -->          
          ...
          <div class="form-group">
            <label class="control-sidebar-subheading">
             {{ Lang::get('core.dash_clearcache') }}
              <a href="{{ url('tecno/config/clearlog') }}"  class="text-red pull-right clearCache"><i class="fa fa-trash-o"></i></a>
            </label>
          </div>
          <!-- /.form-group -->
        </form>
