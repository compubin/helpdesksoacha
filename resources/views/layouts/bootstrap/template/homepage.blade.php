<div class="slider">
	<div class="container text-center" style="padding-top:140px;">
		...
		<h1 data-wow-delay="0.4s" class="nomargin size-50 weight-300 wow fadeInUp animated" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;"><span>Tecno 5</span><span style="color:#fff"> Your Next Future Project Tools </span></h1>
...
<section class="nopadding-bottom">
	<div class="container">
		<header class="text-center margin-bottom-40">
			<h1 class="weight-300">Welcome to Tecno5</h1>
