...
<div class="navbar-default sidebar" role="navigation">
    ...
    @foreach ($sidebar as $menu)
      ...
      @if($menu['module'] =='separator')
        <li class="divider">
              @if($tecnoconfig['cnf_multilang'] ==1 && isset($menu['menu_lang']['title'][Session::get('lang')]))
              ...
              <ul class="nav nav-second-level ">
               @foreach ($menu['childs'] as $menu2)
                <li @if($MenuActive == $menu2['module']) class="active" @endif >
                  ...
                  <span class="hide-menu">
                  @if($tecnoconfig['cnf_multilang'] ==1 && isset($menu2['menu_lang']['title'][Session::get('lang')]))
                    ...
                    <ul class="nav nav-third-level ">
                       @foreach ($menu2['childs'] as $menu3)
                            <li  @if($MenuActive == $menu3['module']) class="active" @endif>
                                ...
                                <span class="hide-menu">
                                @if($tecnoconfig['cnf_multilang'] ==1 && isset($menu3['menu_lang']['title'][Session::get('lang')]))
