...
<head>
    ...
    <!-- Favicon icon -->
    <title>{{ config('tecno.cnf_appname') }}</title>
    ...
    <!-- Legacy  Custom CSS for old tecno layout -->
    ...
    <script src="{{ asset('')}}assets/template/js/tecno5.js"></script>   
...
<body class="fix-header">
    ...
    <div id="wrapper">
      ...
      @include('layouts.leftnav')   
        ...
        <footer class="footer text-center"> {{ date('Y') }} &copy; Todos los derechos reservados - Alcaldía de Soacha - Ing. Edubin Torres </footer>
...
<div class="modal fade" id="tecno-modal" tabindex="-1" role="dialog">
<div class="modal-dialog">
  ...
  <div class="modal-body" id="tecno-modal-content">
...
<script type="text/javascript" src="{{ asset('assets/plugins/datatables/js/natural.js') }}"></script>

@yield('custom-scripts')

    <script>
        $(document).ready(function () {
            var apply_button = $('button[name="apply"]');
