                            ...
                            <li class="col-sm-3">
                                <ul>
                                    <li class="dropdown-header"> Control Panel </li>
                                     <li><a href="{{ url('tecno/config')}}"><i class="icon-screen-desktop"></i> {{ Lang::get('core.tab_siteinfo') }}</a> </li> 
                                     <li><a href="{{ url('tecno/config/email')}}"><i class="icon-link"></i> {{ Lang::get('core.tab_email') }}</a> </li> 
                                     <li><a href="{{ url('tecno/config/security')}}"><i class="icon-lock"></i> {{ Lang::get('core.tab_loginsecurity') }}</a> </li> 
                                     <li><a href="{{ url('tecno/config/translation')}}"><i class="icon-map"></i> {{ Lang::get('core.tab_translation') }}</a> </li>  
                                     <li> <a href="{{ url('tecno/config/clearlog')}}" class="clearCache"><i class="icon-trash"></i> Clear Log & Caches </a> </li>
                           ...
                           @if(Auth::user()->group_id == 1 or Auth::user()->group_id == 2 )
                            ...
                            <li class="col-sm-3">
                                <ul>
                                    ...
                                    <li><a href="{{ url('tecno/module')}}"><i class="icon-fire"></i> Module {{ Lang::get('core.m_codebuilder') }}</a>  </li>
                                    <li><a href="{{ url('tecno/menu')}}"><i class="icon-menu"></i> {{ Lang::get('core.m_menu') }}</a> </li>              
                                    <li><a href="{{ url('tecno/tables')}}"><i class="fa fa-database"></i> {{ Lang::get('core.m_database') }} </a> </li>
                                    <li> <a href="{{ url('tecno/code')}}"><i class="icon-note"></i> {{ Lang::get('core.m_sourceeditor') }}</a>  </li>            
                                    <li><a href="{{ url('core/forms')}}"><i class="icon-list"></i> {{ Lang::get('core.m_formbuilder') }}</a> </li>
                                    <li ><a href="{{ url('tecno/rac')}}"><i class="icon-shuffle"></i> RestAPI Generator </a> </li>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown tasks-menu">
                      ...
                      foreach(SiteHelpers::langOption() as $lang):
                        if($lang['folder'] == session('lang') or $lang['folder'] == $tecnoconfig['cnf_lang']) {
                          $flag = $lang['folder'];
                          $langname = $lang['name']; 
                        }
