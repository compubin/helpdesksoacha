		...
		<div class="box box-primary">
			<div class="box-header with-border">
				...
				<div class="box-header-tools pull-left" >
					@if($access['is_add'] ==1)
						<a href="{{ url('calificaciontickets/update?return='.$return) }}" class="tips btn btn-success btn-circle btn-sm"  title="{{ Lang::get('core.btn_create') }}">
					...
					@endif
					{{--			<a href="{{ url( 'calificaciontickets/search?return='.$return) }}" class="btn btn-warning btn-sm btn-circle" onclick="TecnoModal(this.href,'Advance Search'); return false;" title="{{ Lang::get('core.btn_search') }}"><i class="fa  fa-search"></i> </a>				--}}
				...
				<div class="box-header-tools pull-right" >
					...
					@if($access['is_excel'] ==1)
						<a href="{{ url('/reportecalificacion/export/excel?return='.$return) }}" class="tips  btn btn-primary btn-xs btn-circle"  title="Excel"><i class="fa  fa-arrow-down"></i> </a>
			...
			<div class="box-body ">
				...
				{!! Form::open(array('url'=>'calificaciontickets/delete/', 'class'=>'form-horizontal' ,'id' =>'TecnoTable' )) !!}
				<div class="table-responsive" style="min-height:300px; padding-bottom:60px; border: none !important">
					<table class="table table-bordered table-hover table-tickets" id="{{ $pageModule }}Table">
						<thead>
						<tr>
							<th width="10"  class="number"> No </th>
							<th width="10" > <input type="checkbox" class="checkall" /></th>
							<th width="10" style="width: 10px;">{{ Lang::get('core.btn_action') }}</th>
							...
							<th align="left" class="tbl-sorting" width="100">Tecnico</th>
						...
						{{--@foreach ($rowData as $row)--}}
							{{--@if(Session::get('gid') == 3)--}}
								{{--@include('calificaciontickets.partials.technical_tickets')--}}
							{{--@else--}}
								{{--@include('calificaciontickets.partials.global_tickets')--}}
							{{--@endif--}}
						{{--@endforeach--}}
        ...
        $(document).ready(function(){
            ...
            $(function() {
                ...
                var table = $('.table-tickets').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        'url' : '{!! route('datatable-calificacion') !!}',
                        "data": function ( d ) {
...
<script>
    $(document).ready(function(){
        ...
        $('.copy').click(function() {
            ...
            {
                $('#TecnoTable').attr('action','{{ url("calificaciontickets/copy")}}');
