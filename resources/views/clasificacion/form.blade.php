...
<div class="box box-primary">
	...
	<div class="box-body"> 	
		...
		<ul class="parsley-error-list">
		 ...
		 {!! Form::open(array('url'=>'clasificacion/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Clasificación</legend>
				{!! Form::hidden('id', $row['id']) !!}					
									  <div class="form-group  " >
										<label for="Sub Categoría" class=" control-label col-md-4 text-left"> Sub Categoría <span class="asterix"> * </span></label>
										<div class="col-md-6">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('clasificacion?return='.$return) }}' " class="btn btn-danger  ">  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#sub_categorias_id").jCombo("{!! url('clasificacion/comboselect?filter=sub_categorias:id:nombre') !!}",
		{  selected_value : '{{ $row["sub_categorias_id"] }}' });
		 

		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("clasificacion/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
