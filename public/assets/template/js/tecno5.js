/* Tecno builder 
	copyright 2014 . tecno builder com 
*/
...
function TecnoConfirmDelete( url )
{
...
function TecnoModal( url , title)
{
	$('#tecno-modal-content').html(' ....Loading content , please wait ...');
	$('.modal-title').html(title);
	$('#tecno-modal-content').load(url,function(){
	});
	$('#tecno-modal').modal('show');	
}
