...
class TablesController extends Controller 
{
   	...
   	public function index()
	{
		...
		return view('tecno.tables.index',$this->data);
	}   
    ...
    public function getTableconfig( $table = null )
    {
        ...
        $this->data['action'] = ($table ==null ? 'tecno/tables/tables/'.$table : 'tecno/tables/tableinfo/'.$table ) ;
        return view('tecno.tables.config',$this->data);
    }   
    ...
    public function postTableremove(Request $request)
    {
        ...
        if(!is_null($request->input('id')) && count($request->input('id')) >=1 )
        {
            ...
            return Redirect::to('tecno/tables')->with('messagetext', 'Table(s) has been deleted')->with('msgstatus','success');  
        } 
        return Redirect::to('tecno/tables')->with('messagetext','error','No Table(s) deleted !')->with('msgstatus','error');  
    ...
    public function getTablefieldedit( $table )
    {
        ...
        return view('tecno.tables.field',$this->data);
    }
    ...
    public function getMysqleditor()
    {
        ...
        return view('tecno.tables.editor');
    }   
