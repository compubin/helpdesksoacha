<?php namespace App\Http\Controllers\Tecno;

use App\Models\Tecno\Module;
use App\Library\ZipHelpers;
use App\Library\TecnoHelpers;
...
class ModuleController extends Controller {
	...
	public function index( Request $request)
	{
		...
		return view('tecno.module.index',$this->data);
	}
    ...
    function getCreate()
    {
        ...
        return view('tecno.module.create',$this->data);       
    ...
    function postCreate( Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            if($request->input('creation') == 'manual')
            {
                if($where =="")                
                {
                    return Redirect::to('tecno/module/create')                    
            ...
            $module_type = $primary =='' ? 'report' : ($request->input('module_template') == 'native') ? 'addon' : $request->input('module_template');
            ...
            if(count($row) >= 1)
            {
                ...
                return Redirect::to('tecno/module/rebuild/'.$id->module_id);        
            } else {
                return Redirect::to('tecno/module');
            }
    ...
    function getDestroy( $id = null )
    {
        $row = \DB::table('tb_module')->where('module_id', $id)
                                ->get();        
        if(count($row) <= 0){
            return Redirect::to('tecno/module')->with('messagetext','Can not find module')->with('msgstatus','error');   
    ...
    function getConfig( $id )
    {
        ...
        // Get config Info 
        $fp = base_path().'/resources/views/tecno/module/template/'.$this->getTemplateName($row->module_type).'/config/info.json';
		...
		return view('tecno.module.config',$this->data);        
        ...
        if ($validator->passes()) {
            ...
            if($request->ajax() == true)
            {
                return response()->json(array('status'=>'success','message'=>'Module Info Has Been updated  Successfull')); 
                 ...
                 return redirect('tecno/module/config/'.$request->input('module_name'))
            ...
            if($request->ajax() == true)
            {
                ...
                return Redirect::to('tecno/module/config/'.$request->input('module_name'))
                ->with('messagetext','The following errors occurred')->with('msgstatus','error')
                ->withErrors($validator)->withInput();
            } 
    ...
    public function postSavesetting( Request $request)
    {
        ...
        if($request->ajax() == true)
        {
            return response()->json(array('status'=>'success','message'=>'Module Setting Has Been Save Successfull')); 
             ...
             return Redirect::to('tecno/module/config/'.$row->module_name)
    ...
    function getSql(Request $request , $id )
    {
		...
		return view('tecno.module.sql',$this->data);
    ...
    function postSavesql( Request $request ,$id )
    {
        ...
        try {   
            ...
            // Do something when query fails. 
            $error ='Error : '.$select .' '.$where.' '.$group ;
            return Redirect::to('tecno/module/sql/'.$request->input('module_name'))
       ...
       \DB::table('tb_module')
        ...
        if($request->ajax() == true)
        {
            return response()->json(array('status'=>'success','message'=>'SQL Has Changed Successful.')); 
             ...
             return Redirect::to('tecno/module/sql/'.$row->module_name)
    ...
    function getTable( $id )
    {
		...
		$this->data['module_name'] = $row->module_name;
        $this->data['type']     = ($row->module_type =='ajax' ? 'addon' : $row->module_type);  
		return view('tecno.module.table',$this->data);
    ...
    function getForm( $id )
    {
		...
		$this->data['module_name'] = $row->module_name;
        $this->data['type']     = ($row->module_type =='ajax' ? 'addon' : $row->module_type);  
		return view('tecno.module.form',$this->data);
    ...
    public function postSaveform( Request $request)
    {
        ...
        if($request->ajax() == true)
        {
            ...
            return Redirect::to('tecno/module/form/'.$row->module_name)
    ...
    public function getEditform(Request $request, $id )
    {
        ...
        $this->data['module'] = 'module';
        $this->data['module_name'] = $row->module_name;
        return view('tecno.module.field',$this->data);
    } 
    ...
    public function postSavetable( Request $request)
    {
        ...
        if($request->ajax() == true)
        {
            return response()->json(array('status'=>'success','message'=>'Module Table Has Been Save Successfull')); 
             ...
             return Redirect::to('tecno/module/table/'.$row->module_name)
   ...
   function getPermission( $id )
    {
        ...
        */   
        ...
        $this->data['type']     = ($row->module_type =='ajax' ? 'addon' : $row->module_type);  
        return view('tecno.module.permission',$this->data);
        ...
        */         
        ...
        if($request->ajax() == true)
        {
            return response()->json(array('status'=>'success','message'=>'Permission Has Changed Successful')); 
             ...
             return Redirect::to('tecno/module/permission/'.$row->module_name)
    ...
    function getBuild( $id )
    {
        ...
        return view('tecno.module.build',$this->data);
    ...
    function getFormdesign( Request $request , $id)
    {
        ...
        $this->data['module_name'] = $row->module_name;
        $this->data['type']           = $row->module_type;
        return view('tecno.module.formdesign',$this->data);    
    }   
    ...
    public function postFormdesign( Request $request)
    {
      ...
      \DB::table('tb_module')
        ...
        return Redirect::to('tecno/module/formdesign/'.$row->module_name)
    ...
    function getSub( Request $request, $id ='')
    {
		...
		return view('tecno.module.sub',$this->data);    
    ...
    function postSavesub( Request $request)
    {
        ...
        if ($validator->passes()) {                
            ...
            if($request->ajax() == true)
            {
                ...
                return Redirect::to('tecno/module/sub/'.$row->module_name)
                ->with('messagetext','Master Has beed added Successful.')->with('msgstatus','success');   
            } 

        }    else {

            return Redirect::to('tecno/module/sub/'.$request->get('module_name'))
    ...
    function getConn( Request $request , $id )
    {
        ...
        return view('tecno.module.connection',$this->data);
    }   
   ...
   function configGrid ( $field , $alias , $type, $sort ) {
    ...
    function postDobuild( Request $request ,$id )
    {
        ...
        $url = 'tecno/module/rebuild/'.$id."?rebuild=y&c={$c}&m={$m}&g={$g}&f={$f}&v={$v}&fg={$fg}&fv={$fv}&ff={$ff}";  
    ...
    public function getRebuild(Request $request, $id = 0)
    {
            ...
            if($mType =='addon')
            {
                require_once( base_path().'/resources/views/tecno/module/template/native/config.php');    

            } else {

                
                if(is_dir( base_path().'/resources/views/tecno/module/template/'.$mType ))
                {
                     require_once( base_path().'/resources/views/tecno/module/template/'.$mType.'/config/config.php');
                }  else {
                    ...
                    if($request->ajax() == true && \Auth::check() == true)
                    {
                        ...
                        return Redirect::to('tecno/module')->with('messagetext','Template is Not Exists')
        ...
        if($request->ajax() == true && \Auth::check() == true)
        {
            ...
            return Redirect::to('tecno/module')->with('messagetext','Code Script has been replaced successfull')->with('msgstatus','success');   
        }  
    }  
       ...
       foreach($rows as $row)
        {
            ...
            if($mType =='addon') {
                ...
                include( base_path().'/resources/views/tecno/module/template/native/config/route.php');
            } else {
                include(base_path().'/resources/views/tecno/module/template/'.$row->module_type.'/config/route.php' );
            }
    ...
    function postPackage( Request $request) 
    {
        ...
        return view('tecno.module.package',$this->data);  
  ...
  function postInstall( Request $request ,$id =0)
  {
    ...
    if ($validator->passes()) {
      ...
      $data = \TecnoHelpers::cf_unpackage($path);
      ...
      self::createRouters();
          ...
          return Redirect::to('tecno/module')->with('messagetext','Module Installed' . $msg)->with('msgstatus','success');
    }  else  {
         return Redirect::to('tecno/module')->with('messagetext','Please select file to upload !')->with('msgstatus','error');
    } 
  ...
  function getSubform( Request $request ,$id =0)
  {
      ...
      //  print_r($this->data['subform']);
        ...
        return view('tecno.module.subform',$this->data);  
  }
   ...
   function postSavesubform( Request $request)
    {
        ...
        if ($validator->passes()) {                
            ...
            $row = \DB::table('tb_module')->where('module_id', $id)
                                    ->get();
            if(count($row) <= 0){
                return Redirect::to('tecno/module/subform/'.$request->get('module_name'))
                    ->with('messagetext', 'Can not find module')->with('msgstatus','error');      
            }
            $row = $row[0];                                    
            $this->data['row'] = $row;    
            ...
            */
            ...
            if($request->ajax() == true)
            {
                ...
                return Redirect::to('tecno/module/subform/'.$row->module_name)
    ...
    function getSource( Request $request ,$id)
    {
        ...
        return view('tecno.module.source',$this->data);
...
//       echo '<pre>'; print_r($config); echo '</pre>'; 
        ...
        return view('tecno.module.duplicate',$this->data); 
        ...
        if ($validator->passes()) {
            ...
            if(count($res)>=1)
            {
               ...
               // echo $row->module_id ; exit;
                ...
                return Redirect::to('tecno/module/rebuild/'.$row->module_id.'?mode=duplicate');
         
            } else {
                return Redirect::to('tecno/module')->with('messagetext','Failed to Duplicate Module !' )->with('msgstatus','error');
