...
class PostController extends Controller {
	...
	public static function articles($params , $page , $title = 'all')
	{
		...
		$page = 'layouts.'.config('tecno')['cnf_theme'].'.index';
		$data['pages'] = 'post.index';

		
		if(file_exists(base_path().'/resources/views/layouts/'.config('tecno')['cnf_theme'].'/blog/index.blade.php'))
		{
			$data['pages'] = 'layouts.'.config('tecno.cnf_theme').'.blog.index';
		}
	...
	public function getView( Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			if(file_exists(base_path().'/resources/views/layouts/'.config('tecno')['cnf_theme'].'/blog/view.blade.php'))
			{
				$data['pages'] = 'layouts.'.config('tecno.cnf_theme').'.blog.view';
			}
			return view($page,$data);
		} else {
