    ...
    function convertForm( $id , $rows , $num )
    {
    	...
    	switch ($type)
    	{
  			default;
				...
				<span class="pull-right"><a href="#" onclick="TecnoModal(\''.$edit.'\')"><i class="fa fa-edit "></i> Edit </a> | '.$remove.'</span>
				</div>';
				break;
			...
			case 'hidden';
				...
				<input type="hidden" name="sortlist['.$field.']" class="reorder" value="'.$num.'"  />
				<span class="pull-right"><a href="#" onclick="TecnoModal(\''.$edit.'\')"><i class="fa fa-edit "></i> Edit </a> | 
				'.$remove.'</span>
				</div>';
				break;				
